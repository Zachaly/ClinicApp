...
public class UpdateMedicalProcedureRequestValidatorTests
{
    private readonly UpdateMedicalProcedureRequestValidator _validator;

    public UpdateMedicalProcedureRequestValidatorTests()
    {
        _validator = new UpdateMedicalProcedureRequestValidator();
    }
