...
namespace ClinicApp.Database.Migrations
{
    ...
    [Migration("20260612225313_AddMedicalProcedures")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicApp.Database.Model.DatabaseUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ClinicApp.Domain.Entity.MedicalProcedure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicApp.Domain.Entity.UserClaim", b =>
                {
                    ...
                    b.ToView("vw_UserClaims", (string)null);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ClinicApp.Database.Model.DatabaseUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
